...
class RenderStage6Tests {
   ...
   void testRenderAmbientColor() {
      ...
      scene.geometries.add(
              ...
              _sphere.setMaterial(new Material().setKa(0.5)),

              // Triangle Vert avec un kA très faible (presque noir car kA=0.2)
              _triangleLeftTop.setMaterial(new Material().setKa(0.2))
                      .setEmission(new Color(GREEN)),

              // Triangle Rouge avec un kA élevé (0.8)
              _triangleLeftBottom.setMaterial(new Material().setKa(0.8))
                      .setEmission(new Color(RED)),

              // Triangle Bleu sans atténuation (kA=1.0)
              _triangleRightBottom.setMaterial(new Material().setKa(1.0))
